...
/**
 * Navigations-Liste, geteilt von Desktop-Sidebar und mobilem Drawer.
 * Datengetrieben aus config/navigation.ts. Geplante Module erscheinen
...
/** Logo/Markenzeile, geteilt von Sidebar und Drawer-Kopf. */
